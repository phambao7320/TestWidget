var s=Object.defineProperty;var c=(n,t,e)=>t in n?s(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var i=(n,t,e)=>c(n,typeof t!="symbol"?t+"":t,e);const a=`
    .wcw-container * {
...
`,_="https://prjwondertablestaging-api-staging.azurewebsites.net/api/restaurants";class g{constructor({brandId:t,elementId:e,restaurantId:o}){i(this,"urlClubWonder","https://frontend.staging.club-wonder.jp");i(this,"urlTableCheck","");i(this,"urlCWNavigation","");i(this,"elementId","");i(this,"open",!1);i(this,"widgetContainer",null);i(this,"container",null);i(this,"controlContainer",null);i(this,"getNavigationCWUrl",(t,e)=>{if(t&&e)return`${this.urlClubWonder}/brands/${t}/restaurants/${e}`;if(t)return`${this.urlClubWonder}/brands/${t}/restaurants`;throw new Error("brandId is required")});if(!e)throw new Error("elementId is required");this.open=!1,this.elementId=e,this.urlCWNavigation=this.getNavigationCWUrl(t,o),this.initialize(o),this.injectStyles()}async initialize(t){if(await this.getReserveLink(t),this.container=document.querySelector(`#${this.elementId}`),!this.container)throw new Error("Not found element!");this.clear(),this.container.classList.add("wcw-container"),this.container.style.position="fixed",this.controlContainer=document.createElement("div"),this.controlContainer.classList.add("wcw-wrapper"),this.createControlContainer(),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("wcw-modal__container"),this.widgetContainer.classList.add("wcw-hidden"),this.createModalContent(),this.controlContainer.appendChild(this.widgetContainer),this.container.appendChild(this.controlContainer)}async getReserveLink(t){if(!t)return this.urlTableCheck="";try{const e=await fetch(`${_}/${t}/for-widget`);if(e.status===200){const o=await e.json();this.urlTableCheck=(o==null?void 0:o.tablecheck_booking_url)??""}}catch{this.urlTableCheck=""}}createModalContent(){this.widgetContainer.innerHTML=`
      <div id="wcw-root__modal">
        <div class="wcw-modal__content">
          <div class="wcw-modal__content--close">${d}</div>
