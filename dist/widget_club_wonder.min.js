var s=Object.defineProperty;var a=(n,t,e)=>t in n?s(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var i=(n,t,e)=>a(n,typeof t!="symbol"?t+"":t,e);const c=`
    .wcw-container * {
...
`,_="https://prjwondertablestaging-api-staging.azurewebsites.net/api/restaurants";class g{constructor({brandId:t,elementId:e,restaurantId:o,hiddenUrlTableCheck:l}){i(this,"hiddenUrlTableCheck",!1);i(this,"urlClubWonder","https://frontend.staging.club-wonder.jp");i(this,"urlTableCheck","");i(this,"urlCWNavigation","");i(this,"elementId","");i(this,"open",!1);i(this,"widgetContainer",null);i(this,"container",null);i(this,"controlContainer",null);i(this,"getNavigationCWUrl",(t,e)=>t&&e?`${this.urlClubWonder}/brands/${t}/restaurants/${e}`:`${this.urlClubWonder}/brands/${t}/restaurants`);this.open=!1,this.elementId=e,this.hiddenUrlTableCheck=l,this.urlCWNavigation=this.getNavigationCWUrl(t,o),this.initialize(o),this.injectStyles()}async initialize(t){if(await this.getReserveLink(t),this.container=document.querySelector(`#${this.elementId}`),!this.container)throw new Error("Not found element!");this.clear(),this.container.classList.add("wcw-container"),this.controlContainer=document.createElement("div"),this.controlContainer.classList.add("wcw-wrapper"),this.createControlContainer(),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("wcw-modal__container"),this.widgetContainer.classList.add("wcw-hidden"),this.createModalContent(),this.controlContainer.appendChild(this.widgetContainer),this.container.appendChild(this.controlContainer)}async getReserveLink(t){if(!t)return this.urlTableCheck="";try{const e=await fetch(`${_}/${t}/for-widget`);if(e.status===200){const o=await e.json();this.urlTableCheck=(o==null?void 0:o.tablecheck_booking_url)??""}}catch{this.urlTableCheck=""}}createModalContent(){this.widgetContainer.innerHTML=`
      <div id="wcw-root__modal">
        <div class="wcw-modal__content">
          <div class="wcw-modal__content--close">${w}</div>
          ...
          <a href=${this.urlCWNavigation} target="_blank" class="wcw-modal__link">
            ...
            <span class="wcw-modal__link--icon">${r}</span>
          </a>

          <div class="wcw-modal__body">
            <section class="wcw-modal__body--item">
              <span class="wcw-item__icon">${h}</span>
             ...
             <section class="wcw-modal__body--item">
              <span class="wcw-item__icon">${p}</span>
              <span class="wcw-item__content">
             ...
             <section class="wcw-modal__body--item">
              <span class="wcw-item__icon">${C}</span>
              <span class="wcw-item__content">
    ...
    `;const t=this.widgetContainer.querySelector("#wcw-root__modal"),e=this.widgetContainer.querySelector(".wcw-modal__content"),o=this.widgetContainer.querySelector(".wcw-modal__content--close");t.addEventListener("click",this.toggleOpen.bind(this)),e.addEventListener("click",l=>l.stopPropagation()),o.addEventListener("click",this.toggleOpen.bind(this))}createControlContainer(){const t=!this.hiddenUrlTableCheck&&!!this.urlTableCheck;this.controlContainer.innerHTML=`
      <div class="wcw-control__container">
        <div class="wcw-btn__reserve-cw">Reserve by Club Wonder</div>
        ${t?`<a href="${this.urlTableCheck}" target="_blank" class="wcw-link__reserve--tc">Reserve by Table Check</a>`:""}
      </div>    
    `,this.controlContainer.querySelector(".wcw-btn__reserve-cw").addEventListener("click",this.toggleOpen.bind(this))}injectStyles(){const t=document.createElement("style");t.innerHTML=c.replace(/^\s+|\n/gm,"");const e=document.createElement("style");e.innerHTML="@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap');",document.head.appendChild(t),document.head.appendChild(e)}toggleOpen(){this.open=!this.open,this.open?this.widgetContainer.classList.remove("wcw-hidden"):(this.widgetContainer.classList.add("wcw-hidden"),this.createModalContent())}clear(){this.container&&(this.container.innerHTML="")}}function x(n){if(!n.elementId)throw new Error("elementId is required");if(!n.brandId)throw new Error("brandId is required");return new g(n)}window.initializeWidgetClubWonder=x;
