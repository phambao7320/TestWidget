var u=Object.defineProperty;var t=(a,x,e)=>x in a?u(a,x,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[x]=e;var f=(a,x,e)=>t(a,typeof x!="symbol"?x+"":x,e);const i=`
    .widget__container {
        width: 100%;
        height: 100%;
    }
...
`;class w{constructor({brandId:x,elementId:e,restaurantId:c,urlTableCheck:b}){f(this,"urlClubWonder","https://frontend.staging.club-wonder.jp/");f(this,"urlTableCheck","");f(this,"urlCWNavigation","");f(this,"elementId","");f(this,"open",!1);f(this,"widgetContainer",null);f(this,"container",null);f(this,"controlContainer",null);f(this,"getNavigationCWUrl",(x,e)=>{if(x&&e)return this.urlClubWonder+"/brands/"+x+"/restaurants/"+e;if(x)return this.urlClubWonder+"/brands/"+x+"/restaurants";throw new Error("brandId is required")});if(!e)throw new Error("elementId is required");this.elementId=e,this.urlTableCheck=b,this.urlCWNavigation=this.getNavigationCWUrl(x,c),this.open=!1,this.initialize(),this.injectStyles()}async initialize(){if(this.container=document.querySelector("#"+this.elementId),!this.container)throw new Error("Not found element!");this.container.classList.add("widget__container"),this.container.style.position="fixed",document.body.appendChild(this.container),this.controlContainer=document.createElement("div"),this.controlContainer.classList.add("widget__wrapper"),this.createControlContainer(),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("modal__container"),this.widgetContainer.classList.add("widget__hidden"),this.createModalContent(),this.controlContainer.appendChild(this.widgetContainer),this.container.appendChild(this.controlContainer)}createModalContent(){this.widgetContainer.innerHTML=`
      <div id="root__modal">
        <div class="modal__content">
          <div class="modal__content--close">`+h+`</div>
          ...
          <a href=`+this.urlCWNavigation+` target="_blank" class="modal__link">
            ...
            <span class="modal__link--icon">`+n+`</span>
          </a>

          <div class="modal__body">
            <section class="modal__body--item">
              <span class="item__icon">`+o+`</span>
    ...
    `;const x=this.widgetContainer.querySelector("#root__modal"),e=this.widgetContainer.querySelector(".modal__content"),c=this.widgetContainer.querySelector(".modal__content--close");x.addEventListener("click",this.toggleOpen.bind(this)),e.addEventListener("click",b=>b.stopPropagation()),c.addEventListener("click",this.toggleOpen.bind(this))}createControlContainer(){this.controlContainer.innerHTML=`
    ...
    `,this.controlContainer.querySelector(".btn__reserve--cw").addEventListener("click",this.toggleOpen.bind(this))}injectStyles(){const x=document.createElement("style");x.innerHTML=i.replace(/^\s+|\n/gm,"");const e=document.createElement("style");e.innerHTML="@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap');",document.head.appendChild(x),document.head.appendChild(e)}toggleOpen(){this.open=!this.open,this.open?this.widgetContainer.classList.remove("widget__hidden"):this.widgetContainer.classList.add("widget__hidden")}clear(){this.container&&document.body.removeChild(this.container)}}let d=null;function I(a){return d=new w(a),d}function m(){d&&(d.clear(),d=null)}window.initializeWidgetClubWonder=I,window.clearWidgetClubWonder=m;
