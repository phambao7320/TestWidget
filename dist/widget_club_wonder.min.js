var s=Object.defineProperty;var a=(n,t,e)=>t in n?s(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var i=(n,t,e)=>a(n,typeof t!="symbol"?t+"":t,e);const d=`
    .widget__container {
        width: 100%;
        height: 100%;
    }
...
`;class g{constructor({brandId:t,elementId:e,restaurantId:o,urlTableCheck:l}){i(this,"urlClubWonder","https://frontend.staging.club-wonder.jp/");i(this,"urlTableCheck","");i(this,"urlCWNavigation","");i(this,"elementId","");i(this,"open",!1);i(this,"widgetContainer",null);i(this,"container",null);i(this,"controlContainer",null);i(this,"getNavigationCWUrl",(t,e)=>{if(t&&e)return`${this.urlClubWonder}/brands/${t}/restaurants/${e}`;if(t)return`${this.urlClubWonder}/brands/${t}/restaurants`;throw new Error("brandId is required")});if(!e)throw new Error("elementId is required");this.elementId=e,this.urlTableCheck=l,this.urlCWNavigation=this.getNavigationCWUrl(t,o),this.open=!1,this.initialize(),this.injectStyles(),console.log("OKE")}async initialize(){if(this.container=document.querySelector(`#${this.elementId}`),!this.container)throw new Error("Not found element!");this.container.classList.add("widget__container"),this.container.style.position="fixed",this.controlContainer=document.createElement("div"),this.controlContainer.classList.add("widget__wrapper"),this.createControlContainer(),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("modal__container"),this.widgetContainer.classList.add("widget__hidden"),this.createModalContent(),this.controlContainer.appendChild(this.widgetContainer),this.container.appendChild(this.controlContainer)}createModalContent(){this.widgetContainer.innerHTML=`
      <div id="root__modal">
        <div class="modal__content">
          <div class="modal__content--close">${c}</div>
          ...
          <a href=${this.urlCWNavigation} target="_blank" class="modal__link">
            ...
            <span class="modal__link--icon">${p}</span>
          </a>

          <div class="modal__body">
            <section class="modal__body--item">
              <span class="item__icon">${h}</span>
    ...
    `;const t=this.widgetContainer.querySelector("#root__modal"),e=this.widgetContainer.querySelector(".modal__content"),o=this.widgetContainer.querySelector(".modal__content--close");t.addEventListener("click",this.toggleOpen.bind(this)),e.addEventListener("click",l=>l.stopPropagation()),o.addEventListener("click",this.toggleOpen.bind(this))}createControlContainer(){this.controlContainer.innerHTML=`
      <div class="control__container">
        <div class="btn__reserve--cw">Reserve by Club Wonder</div>
        ${this.urlTableCheck?`<a href="${this.urlTableCheck}" target="_blank" class="link__reserve--tc">Reserve by Table Check</a>`:null}
      </div>    
    `,this.controlContainer.querySelector(".btn__reserve--cw").addEventListener("click",this.toggleOpen.bind(this))}injectStyles(){const t=document.createElement("style");t.innerHTML=d.replace(/^\s+|\n/gm,"");const e=document.createElement("style");e.innerHTML="@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap');",document.head.appendChild(t),document.head.appendChild(e)}toggleOpen(){this.open=!this.open,this.open?this.widgetContainer.classList.remove("widget__hidden"):this.widgetContainer.classList.add("widget__hidden")}clear(){this.container&&document.body.removeChild(this.container)}}function x(n){return console.log("debug",n),new g(n)}function m(){}window.initializeWidgetClubWonder=x;window.clearWidgetClubWonder=m;
