...
`;class g{constructor({brandId:t,elementId:e,restaurantId:o,urlTableCheck:l}){i(this,"urlClubWonder","https://frontend.staging.club-wonder.jp/");i(this,"urlTableCheck","");i(this,"urlCWNavigation","");i(this,"elementId","");i(this,"open",!1);i(this,"widgetContainer",null);i(this,"container",null);i(this,"controlContainer",null);i(this,"getNavigationCWUrl",(t,e)=>{if(t&&e)return`${this.urlClubWonder}/brands/${t}/restaurants/${e}`;if(t)return`${this.urlClubWonder}/brands/${t}/restaurants`;throw new Error("brandId is required")});if(!e)throw new Error("elementId is required");this.elementId=e,this.urlTableCheck=l,this.urlCWNavigation=this.getNavigationCWUrl(t,o),this.open=!1,this.initialize(),this.injectStyles()}async initialize(){if(this.container=document.querySelector(`#${this.elementId}`),!this.container)throw new Error("Not found element!");this.clear(),this.container.classList.add("widget__container"),this.container.style.position="fixed",this.controlContainer=document.createElement("div"),this.controlContainer.classList.add("widget__wrapper"),this.createControlContainer(),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("modal__container"),this.widgetContainer.classList.add("widget__hidden"),this.createModalContent(),this.controlContainer.appendChild(this.widgetContainer),this.container.appendChild(this.controlContainer)}createModalContent(){this.widgetContainer.innerHTML=`
    ...
    `;const t=this.widgetContainer.querySelector("#root__modal"),e=this.widgetContainer.querySelector(".modal__content"),o=this.widgetContainer.querySelector(".modal__content--close");t.addEventListener("click",this.toggleOpen.bind(this)),e.addEventListener("click",l=>l.stopPropagation()),o.addEventListener("click",this.toggleOpen.bind(this))}createControlContainer(){this.controlContainer.innerHTML=`
      <div class="control__container">
        ...
        ${this.urlTableCheck?`<a href="${this.urlTableCheck}" target="_blank" class="link__reserve--tc">Reserve by Table Check</a>`:""}
      </div>    
