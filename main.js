...
class WidgetClubWonder {
  ...
  getNavigationCWUrl = (brandId, restaurantId) => {
  ...
  createModalContent() {
    ...
    btnCloseModal.addEventListener("click", this.toggleOpen.bind(this));
  }
  ...
  injectStyles() {
    ...
    styleFont.innerHTML = `@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap');`;
